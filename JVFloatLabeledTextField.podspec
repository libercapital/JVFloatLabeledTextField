Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/libercapital/JVFloatLabeledTextField"
  ...
  s.source       = { :git => "https://github.com/libercapital/JVFloatLabeledTextField.git", :tag => s.version.to_s }
  s.platform     = :ios
